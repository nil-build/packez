...
module.exports = function (opts) {
  ...
  const getStyleLoaders = function (cssOptions, preProcessor) {
    ...
    return [{
      ...
      use: [opts.inlineStyle ? require.resolve("style-loader") : require(require.resolve("mini-css-extract-plugin")).loader, {
        loader: require.resolve('css-loader'),
        options: {
          importLoaders: cssOptions.importLoaders,
          loaders: true
  ...
  loaders.babel && {
    ...
    options: {
      ...
      configFile: true,
      compact: false,
      presets: [[require.resolve("babel-preset-packez"), _lodash.default.defaultsDeep({}, _lodash.default.isObject(loaders.babel) ? loaders.babel : {}, {
        runtimeOptions: {
          corejs: 2,
          helpers: true,
          regenerator: true
