...
module.exports = function (cfg) {
  ...
  if (cfg.module.css) {
    oneOf.push({
      ...
      require(require.resolve("mini-css-extract-plugin")).loader, require.resolve('css-loader'), {
        loader: require.resolve("postcss-loader"),
        options: postConfig(cfg) // options: {
        //     config: {
  ...
  const exclude = [/\.ejs$/, /\.jsx?$/, /\.css$/, /\.scss$/, /\.less$/, /\.json5?$/, /\.html?$/, cfg.rawLoaderRegexp, assestMedia.regexp];
