...
module.exports = function (opts) {
  ...
  const getBabelLoader = function (babelOptions) {
    ...
    return {
      ...
      options: {
        babelrc: _lodash.default.get(babelOptions, 'babelrc', false),
        configFile: _lodash.default.get(babelOptions, 'configFile', false),
        compact: _lodash.default.get(babelOptions, 'compact', false),
        presets: [[require.resolve("babel-preset-packez"), _lodash.default.defaultsDeep({}, _lodash.default.omit(babelOptions, ['plugins', 'babelrc', 'configFile', 'compact']), {
          runtimeOptions: {
            corejs: 2,
            helpers: true,
            regenerator: true
