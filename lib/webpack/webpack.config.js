...
module.exports = function (opts) {
  ...
  const options = {
    ...
    devtool: opts.devtool || (isEnvProduction ? opts.shouldUseSourceMap ? "source-map" : false : isEnvDevelopment && "cheap-module-source-map"),
    entry: opts.entry,
    output: _lodash.default.defaultsDeep(opts.output || {}, {
